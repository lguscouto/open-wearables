...
description: "Supported wearable and fitness integrations including Garmin, Whoop, Polar, Oura, Fitbit, Withings, Apple Health, and Google Health Connect. Cloud OAuth and mobile SDK integrations, with more added regularly."
...
"og:description": "Connect wearables and fitness platforms - Garmin, Whoop, Polar, Oura, Fitbit, Withings, Apple Health, Google Health Connect, and more - via cloud OAuth and mobile SDKs."
...
"twitter:description": "Connect wearables and fitness platforms - Garmin, Whoop, Polar, Oura, Fitbit, Withings, Apple Health, Google Health Connect, and more - via cloud OAuth and mobile SDKs."
...
| **Amazfit / Zepp** | [Setup Guide →](/providers/zepp-api-integration) | Connect via Zepp app token and user ID |
| **Withings** | [Setup Guide →](/providers/withings-api-integration) | Withings account required; webhook subscriptions are created per-user, not per-app |
